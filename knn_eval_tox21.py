...
def run_knn_eval_tox21(
    ...
    plot_path = f"models/{ssl_model_name}/knn_tox21_mean_rocauc_embeddings_vs_fingerprints.png"
    ...
    metadata["KNN_eval_Tox21"] = {
        "dataset": "Tox21",
        "data_source": "deepchem.molnet.load_tox21",
        "splitter": split_stats["splitter"],
        "split_seed": split_stats.get("split_seed"),
        "n_tasks_total": int(split_stats["n_tasks"]),
        "n_tasks_evaluated": int(len(per_task_results)),
        "evaluation_primary_metric": "roc_auc_mean_tasks",
        "k_values": K_VALUES,
        "fingerprint": {
            "type": "Morgan",
            "radius": FP_RADIUS,
        ...
        "aggregate": {
            "embeddings": {
                "validation_metrics": {
                    "roc_auc_mean_tasks": round(emb_val_mean, 4),
                    "roc_auc_std_tasks": round(emb_val_std, 4),
                },
                "test_metrics": {
                    "roc_auc_mean_tasks": round(emb_test_mean, 4),
                    "roc_auc_std_tasks": round(emb_test_std, 4),
                },
            },
            "fingerprints": {
                "validation_metrics": {
                    "roc_auc_mean_tasks": round(fp_val_mean, 4),
                    "roc_auc_std_tasks": round(fp_val_std, 4),
                },
                "test_metrics": {
                    "roc_auc_mean_tasks": round(fp_test_mean, 4),
                    "roc_auc_std_tasks": round(fp_test_std, 4),
                },
            },
        },
